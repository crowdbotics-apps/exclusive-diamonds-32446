...
## Project Structure
    ...
    ├── exclusive_diamonds_32446  # Django project configurations
...
1. Clone this repo and `cd exclusive_diamonds_32446`
...
2. Clone this repo and `cd exclusive_diamonds_32446`
